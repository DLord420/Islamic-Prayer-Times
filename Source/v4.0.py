""" A simple script to show Islamic prayer and related times for Tehran (Tajrish), Iran.  You could change the location in the script.  Times related to my working hours are highlighted.  DLord """
...
# you can change the area, city, and country tags here:
Area = "Tajrish"
City = "Tehran"
Country = "Iran"
...
def get_jalali_date() -> str:
    ...
    todayJ = jlist[3] + ", " + jlist[2] + " " + months[jlist[1]] + ", " + jlist[0]
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Location: \033[1;32m{City} ({Area}) - {Country}\033[0m")
        print(
